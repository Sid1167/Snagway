            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-body">
                      <form method="post" action="save-user-update.jsp">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" value="<%= rs.getString("name") %>" name="ur-name"  />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Username</label>
                          <input type="text" class="form-control" id="basic-default-company" value="<%= rs.getString("username") %>" name="ur-username"  />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                         ...
                         <input id="basic-default-phone" type="text" name="ur-pass"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
